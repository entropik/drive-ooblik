-- Script d'initialisation PostgreSQL pour Drive Ooblik
-- Ce script est exécuté automatiquement lors du premier démarrage du container PostgreSQL
...
-- Table des migrations (pour le tracking)
